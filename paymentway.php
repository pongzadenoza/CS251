			...
			<div class="row">
				<div class="col-md-6">
					<div class="login-form">
						<h3 class="billing-title text-center">ชำระเงินปลายทาง</h3>
						<p class="text-center mt-80 mb-40">กรุณากรอกข้อมูล</p>
						<form name="login-form" action="login_mng.php" method="POST">
							...
							<input name="cads" type="text" placeholder="จำนวนเงิน*" onfocus="this.placeholder=''" onblur="this.placeholder = 'จำนวนเงิน*'" required class="common-input mt-20">
							<button class="view-btn color-2 mt-20 w-100"><span>Confirm</span></button>
				...
				<div class="col-md-6">
					<div class="register-form">
						<h3 class="billing-title text-center">ชำระเงินผ่านบัตรเครดิต</h3>
						<p class="text-center mt-40 mb-30">กรุณากรอกข้อมูล </p>
						<form action="credit_mng.php" method="POST">
							<input name ="cname" type="text" placeholder="Full name*" onfocus="this.placeholder=''" onblur="this.placeholder = 'Full name*'" required class="common-input mt-20">
							...
							<input name="cphone" type="text" placeholder="Phone number*" onfocus="this.placeholder=''" onblur="this.placeholder = 'Phone number*'" required class="common-input mt-20">
							<input name="cads" type="text" placeholder="Address*" onfocus="this.placeholder=''" onblur="this.placeholder = 'Address*'" required class="common-input mt-20">
							<input name="cusr" type="text" placeholder="Credit Card Number*" onfocus="this.placeholder=''" onblur="this.placeholder = 'Credit Card Number*'" required class="common-input mt-20">
							<input name= "cpwd" type="password" placeholder="CVC*" onfocus="this.placeholder=''" onblur="this.placeholder = 'CVC*'" required class="common-input mt-10">
